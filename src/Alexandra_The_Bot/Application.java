...
//	private final MarryTTS tts = new MarryTTS();
...
//
//		// tts.setVoice("bits1-hsmm"); // Female DE
//		// tts.setVoice("bits3-hsmm"); // Male DE // the best german voice
//
//		// tts.setVoice("dfki-poppy-hsmm"); // Female USA
//		// tts.setVoice("cmu-slt-hsmm"); // Female USA
//		// tts.setVoice("dfki-prudence-hsmm"); // Female uk
//
//		// tts.setVoice("dfki-spike-hsmm"); // male USA // best english voice
//		// tts.setVoice("cmu-bdl-hsmm"); // Male USA
//
//		// JetPilotEffect
...
//	//
//	// } else if (output.contains("do you have any boyfriend")) { // do you have any
//	// boyfriend
//	// speak("Yes");
//	//
...
//	//
//	// } else if (output.contains("I think you're funny") || output.contains("I
//	// think you are funny")) {// I think you
//	// // are funny
//	// speak("Yeah you too!");
//	//
...
//	//
//	// } else if (output.contains("who's your daddy") || output.contains("but I am
...
//	//
//	// } else if (output.contains("why do you speak like that")) {// why do you
//	// speak like that
//	// speak("Like what?");
//	//
...
//	//
//	// } else if (output.contains("stop speech recognition")) {// Stop Speech
//	// Recognition
