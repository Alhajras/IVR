...
public class TextToSpeech {
	 ...
	 */
	public void speak(String text, float gainValue, boolean daemon, boolean join, String callerId)
			throws UnsupportedEncodingException {
		if (iAmBusy)
			return;
		iAmBusy = true;
		...
		try (AudioInputStream audio = marytts.generateAudio(text)) {
			...
			String fileNameSource = "D:\\IVR\\SharedFolderWinLinux\\marryTTSOutput\\16k\\marryTTS" + callerId + ".wav";
			String fileNameDestinaion = "D:\\IVR\\SharedFolderWinLinux\\marryTTSOutput\\8k\\marryTTS" + callerId
					+ ".wav";
			try {
