...
public class MaryTTSTester {

	/**
	 * The test-main method from which our application is starting
	 * 
	 * @param args
	 */
	public static void main(String[] args) {
		...
		// =========================================================================
		List<String> arrayList = Arrays.asList("Are you mad bro", "I am gay", "Bro pliz tell me i am gay ok?",
				"But gay is ok remember");

		// Loop infinitely
		for (int i = 0; i < 150.000; i++)
			arrayList.forEach(word -> {
				try {
					tts.speak(word, 2.0f, false, true, null);
	...
	public void tutorial_1_2_3_FromYoutube() throws UnsupportedEncodingException {
		...
		// TTS say something that we actually are typing into the first variable
		tts.speak("Who is Mary Bob?", 2.0f, false, true, null);

		// Setting the Voice
		tts.setVoice("cmu-rms-hsmm");

		// TTS say something that we actually are typing into the first variable
		tts.speak("No one my darling...", 2.0f, false, true, null);

		// Setting the Voice
		tts.setVoice("dfki-poppy-hsmm");

		// TTS say something that we actually are typing into the first variable
		tts.speak("I don't trust you", 2.0f, false, true, null);

		// Setting the Voice
		tts.setVoice("cmu-rms-hsmm");

		// TTS say something that we actually are typing into the first variable
		tts.speak("Oh yeah baby!", 2.0f, false, true, null);

		// Setting the Voice
		tts.setVoice("dfki-poppy-hsmm");

		// TTS say something that we actually are typing into the first variable
		tts.speak("aaaaaa", 2.0f, false, true, null);

		// Setting the Voice
		tts.setVoice("cmu-rms-hsmm");

		// TTS say something that we actually are typing into the first variable
		tts.speak("yeah!", 2.0f, false, true, null);

		// Setting the Voice
		tts.setVoice("dfki-poppy-hsmm");

		// TTS say something that we actually are typing into the first variable
		tts.speak("oh oh yeah!", 2.0f, false, true, null);

		// Setting the Voice
		tts.setVoice("dfki-poppy-hsmm");

		// TTS say something that we actually are typing into the first variable
		tts.speak("I am Elize , a wonderful girl!", 2.0f, false, true, null);

		// Setting the Voice
		tts.setVoice("cmu-rms-hsmm");

		// TTS say something that we actually are typing into the first variable
		tts.speak("Shut up Elize . Let's continue our tutorials!", 2.0f, false, true, null);
