...
/**
 * Sends a text message to a given channel while in a call. An active channel
 * and a text message are required in order to success.
 * <p>
 * It is defined in <code>main/manager.c</code>.
 * <p>
...
public class SendTextAction extends AbstractManagerAction {
	...
	/**
	 * Creates a new SendTextAction that sends the given message to the given
	 * channel.
	 *
	 * @param channel
